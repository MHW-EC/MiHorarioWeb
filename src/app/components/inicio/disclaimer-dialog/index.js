	...
	return (
		<div className={classes.dialogContent}>
			<Typography variant='body1'>
				...
				Probablemente actualicemos la información hoy 10/05/2020 - 23:59:59, sin
				embargo revise su horario con los planificados en la página oficial.
			</Typography>
			<br />
			<Typography variant='body1'>
